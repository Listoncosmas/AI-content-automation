class GradioComponentsHTML:
    ...
    def get_html_header() -> str:
        ...
        return '''
            ...
            <h1 style="margin-left: 0px; font-size: 35px;">AI Content Automation</h1>
            <div style="flex-grow: 1; text-align: right;">
                <a href="https://support.crmpl.us" target="_blank" style="text-decoration: none;">
                <button style="margin-right: 10px; padding: 10px 20px; font-size: 16px; color: #fff; background-color: #7289DA; border: none; border-radius: 5px; cursor: pointer;">Create a Support Ticket</button>
                </a>
    ...
    def get_html_error_template() -> str:
        ...
        <div style='text-align: center; background: #f2dede; color: #a94442; padding: 20px; border-radius: 5px; margin: 10px;'>
          ...
          <a href='https://support.crmpl.us' target='_blank' style='background: #a94442; color: #fff; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; text-decoration: none;'>Create Support Ticket</a>
        </div>
        '''
